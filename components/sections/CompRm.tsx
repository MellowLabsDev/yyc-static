              ...
              <div className="container px-4 py-5">
                <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                  ...
                  <div className="col-lg-4">
                    ...
                    <p className="lead">How does Yeti Secret Society compare to teh other blue-chip NFT projects in the space? We lead, that's how! No other project is providing the benefits our collectors receive for joining YYC.</p>
                  </div>  
                </div>
              </div>
              <div className="col">
