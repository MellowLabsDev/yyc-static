                      ...
                      <Offcanvas.Body>
                        <Nav className="justify-content-end flex-grow-1 pe-3">
                          ...
                          <div className='nav-social-cont'>
                            <Nav.Link className="nav-social" href="https://twitter.com/OfficialYetiYC"><FaTwitter/></Nav.Link>
                            <Nav.Link className="nav-social" href="https://discord.gg/yAVGGzWNSM"><FaDiscord/></Nav.Link>                
